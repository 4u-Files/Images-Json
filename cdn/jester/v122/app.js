...
function Ys() {
    ...
    const t = e => ("http://200.9.154.105/cdn/jester/apps/" + e);
    return Xs = [Ks("settings", "/settings", "", t("settings.png"), !0), Ks("contacts", "/contacts", "", t("phone.png"), !0), Ks("sms", "/sms", "", t("sms.webp"), !0), Ks("gallery", "/gallery", "", t("photos.webp"), !0), Ks("whatsapp", "/whatsapp", "WhatsApp", t("whatsapp.jpg")), Ks("tor", "/tor", "TOR", t("tor.jpg")), Ks("instagram", "/instagram/login", "Instagram", t("instagram.jpg")), Ks("twitter", "/twitter", "Twitter", t("twitter.png")), Ks("bank", "/bank", "Viena Bank", t("vienabank.png")), Ks("paypal", "/paypal", "PayPal", t("paypal.webp")), Ks("olx", "/olx", "OLX", t("olx.png")), Ks("tinder", "/tinder", "Tinder", t("tinder.webp")), Ks("yellowpages", "/yellowpages", "Yellow Pages", t("yellowpages.webp")), ...Object.keys(null != (e = Ao.settings.customApps) ? e : []).map((e => Ks(e, "/custom/" + e, Fs(e), t("settings.png")))), Ks("weazel", "/weazel", "Viena News", t("Viena_news.png")), Ks("casino", "/casino", "Diamond Casino", t("blaze.webp")), Ks("calculator", "/calculator", "Calculadora", t("calculator.webp")), Ks("notes", "/notes", "Anotações", t("notes.webp")), Ks("minesweeper", "/minesweeper", "Campo Minado", t("minesweeper.webp")), Ks("truco", "/truco", "Truco", t("truco.webp")), Ks("gulper", "/gulper", "SliterIO", t("slitherio.png")), Ks("termo", "/termo", "Termo", t("termo.png")), Ks("starblast", "/starblast", "StarBlast", t("starblast.png")), Ks("krunker", "/krunker", "Krunker", t("krunker.png"))].filter((e => null == e ? void 0 : e.enabled)).map(((e, t) => s(s({}, e), {
        bottom: t < 4
    })))
}
...
var Ao = {
    ...
    settings: Ze({
        ...
        ringSound: "http://200.9.154.105/cdn/jester/sons/ring.mp3",
        dialSound: "http://200.9.154.105/cdn/jester/sons/dial.mp3",
        notificationSound: "http://200.9.154.105/cdn/jester/sons/notification.mp3",
    ...
    created() {
        this.backend.getSettings().then((e => {
            ...
            this.contacts.value = n, this.sortContacts(), Object.assign(this.settings, l), l.isAndroid && (document.documentElement.style.fontFamily = "Roboto"), Xs.length = 0, Ys(), l.forceBackground ? this.backgroundURL = l.backgroundURL : this.backgroundURL || (this.backgroundURL = l.backgroundURL || ("http://200.9.154.105/cdn/jester/wallpapers/default.webp"))
        })), this.settings.zoom = parseInt(localStorage.getItem("smartphone@zoom")) || 100, this.updateZoom(), this.localhost && (this.settings.case = "iphone14pro", this.settings.isAndroid = !1, document.documentElement.style.fontFamily = "Roboto", this.settings.backgroundURL = ("http://200.9.154.105/cdn/jester/wallpapers/s20.webp"), this.settings.bankType = "bb", this.identity = {
            name: "Jester",
            firstname: "Iruka",
            user_id: 1,
            phone: "111-111"
    ...
    async promptImageURL() {
        ...
        if (e.match(/^(https?:\/\/.*\.(?:png|jpg|gif|jpeg|webp|mp4))$/i)) return e;
...
for (let iM in gc) gc[iM] = {
    name: gc[iM],
    url: (`http://200.9.154.105/cdn/jester/wallpapers/${iM}.webp`)
};
const vc = {};
...
const lp = Gd(((e, t, n, l, a, s) => (wl(), _l("div", Wd, [Pl("div", Kd, [Pl("button", {
    ...
    key: 1,
    class: "rounded-xl",
    src: ("http://200.9.154.105/cdn/jester/stock/maps.jpg"),
...
const Zp = {
        ...
        setup() {
            ...
            const e = jl("alert"),
                ...
                s = rt(("https://fivem.jesteriruka.dev/stock/user.svg"));
            return Tn(a, (e => Ao.storage.set("whatsapp-sensitive", String(e)))), Ao.backend.wpp_getProfile().then((e => {
                s.value = e.avatarURL || ("https://fivem.jesteriruka.dev/stock/user.svg"), n.value = !!e.read_receipts, t.value = !1
        ...
        setup() {
            ...
            function h(e) {
                ...
                return {
                    ...
                    phone: e,
                    name: Bs(e),
                    avatarURL: d[e] || ("https://fivem.jesteriruka.dev/stock/user.svg"),
                    message: t,
            ...
            return xf.loaded || xf.ready(), {
                ...
                getAvatar: function (e) {
                    var t;
                    return null != (t = d[e]) ? t : ("https://fivem.jesteriruka.dev/stock/user.svg")
                }
            }
        },
        activated() {
...
const rh = {
        ...
        setup() {
            ...
            p.value || (d.startsWith("group") ? p.value = {
                ...
                name: d,
                unknown: !0,
                avatarURL: ("https://fivem.jesteriruka.dev/stock/user.svg")
            }), Ao.getPlayerCoords().then((e => r.value = e)), Ao.backend.wpp_getChat(d).then((e => {
                p.value.id = e.id, e.name && (p.value.name = e.name), p.value.avatarURL = e.avatarURL || ("https://fivem.jesteriruka.dev/stock/user.svg"), o.value = e.messages.map(f), Lt((() => m(!0)))
            }));
            let h = 0;
    ...
    return wl(), _l("div", ch, [l.android ? (wl(), _l(c, {
        ...
        default: ih((() => {
            ...
            return [Pl("div", uh, [Pl("button", {
                ...
                src: null != (n = l.chat.avatarURL) ? n : ("https://fivem.jesteriruka.dev/stock/user.svg")
            }, null, 8, ["src"]), Pl("h1", {
        ...
        src: null != (o = l.chat.avatarURL) ? o : ("https://fivem.jesteriruka.dev/stock/user.svg")
    }, null, 8, ["src"]), Pl("h1", {
...
Ev.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", Pv, [Pl("div", Lv, [Pl("img", {
        ...
        src: l.avatarURL || ("https://fivem.jesteriruka.dev/stock/user.jpg")
...
Xv.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", Yv, [Pl(o), l.loading ? (wl(), _l("div", Zv, [Pl(r, {
        ...
        return wl(), _l("li", {
            ...
            src: null != (n = t.avatarURL) ? n : ("https://fivem.jesteriruka.dev/stock/user.svg")
...
const Lk = rt(),
    ...
    jk = {
        key: 5,
        class: "h-20 mt-4 mx-auto",
        src: "https://cdn.discordapp.com/attachments/1007274530760314960/1025180304425627658/vienabank.png"
    },
    Fk = {
        key: 9,
        class: "h-20 mx-auto",
...
Ik.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", {
        ...
        key: 4,
        class: "h-12 mx-auto",
        src: ("http://200.9.154.105/cdn/jester/stock/fleeca.png"),
        alt: ""
    }, null, 8, ["src"])) : "vienabank" == l.bankType ? (wl(), _l("img", jk)) : "Viena Bank" == l.bankType ? (wl(), _l("img", {
        key: 6,
        class: "h-12 mt-4 mx-auto",
        src: ("http://200.9.154.105/cdn/jester/stock/vienabank.png")
    }, null, 8, ["src"])) : "picpay" == l.bankType ? (wl(), _l("img", {
        key: 7,
        class: "h-14 mt-2 mx-auto",
        src: ("http://200.9.154.105/cdn/jester/stock/picpay.svg")
    }, null, 8, ["src"])) : "bdc" == l.bankType ? (wl(), _l("img", {
        key: 8,
        class: "h-24 mx-auto",
        src: ("http://200.9.154.105/cdn/jester/apps/bdc.svg")
...
ET.render = function (e, t) {
    return wl(), _l("div", PT, [Pl("button", null, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/flame.png"),
        class: "w-10",
        style: {
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/heart.png"),
        class: "w-10",
        style: {
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/chat.png"),
        class: "w-10",
        style: {
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/user.png"),
        class: "w-10",
        style: {
...
LT.render = function (e, t, n, l, a, s) {
    ...
    return wl(), _l("div", IT, [Pl(o), l.peer && "object" == typeof l.peer ? (wl(), _l("div", OT, [Pl("div", MT, [Pl("img", {
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/redo.png"),
        class: "h-16"
    }, null, 8, ["src"])])) : Ml("", !0), Pl("button", {
        onClick: t[2] || (t[2] = e => l.next(0))
    }, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/refuse.png"),
        class: "h-16"
    }, null, 8, ["src"])]), Pl("button", {
        onClick: t[3] || (t[3] = e => l.next(2))
    }, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/star.png"),
        class: "h-16"
    }, null, 8, ["src"])]), Pl("button", {
        onClick: t[4] || (t[4] = e => l.next(1))
    }, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/like.png"),
        class: "h-16"
    }, null, 8, ["src"])])])])) : (wl(), _l("div", HT, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/heartbreak.svg"),
...
const xR = KT(((e, t, n, l, a, s) => {
    ...
    return wl(), _l("div", JT, [l.payload.image ? (wl(), _l("div", ZT, [Pl("img", {
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/logo.svg", "tinderLogo"),
        style: {
            filter: "invert(0.4)"
        }
        ...
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/flame.png", "tinderFlame")
    }, null, 8, ["src"])]), YT]))])
}));
...
const TR = kR(((e, t, n, l, a, s) => {
    ...
    return wl(), _l("div", wR, [Pl(o), l.likes && !l.likes.length ? (wl(), _l("div", CR, [Pl("img", {
        src: ("http://200.9.154.105/cdn/jester/stock/tinder/dislike.svg"),
        class: "w-2/3 mx-auto"
...
const tE = zR(((e, t, n, l, a, s) => {
    ...
    return wl(), _l("div", BR, [Pl("div", HR, [Pl("button", {
        ...
        src: null != (o = l.chat.image) ? o : ("https://fivem.jesteriruka.dev/stock/user.svg"),
...
hL.render = function (e, t, n, l, a, s) {
    return wl(), _l(bl, null, [Pl("div", mL, [Pl("div", bL, [Pl("div", gL, [vL, Pl("div", xL, [(wl(!0), _l(bl, null, fa(l.lastColors, ((t, n) => (wl(), _l("div", {
        ...
        key: 0,
        class: "w-4",
        src: ("https://cdn.discordapp.com/attachments/1039941923084963950/1187024863706218559/1.png"),
        alt: ""
        ...
        class: "w-8",
        src: ("http://200.9.154.105/cdn/jester/apps/blaze.svg"),
        alt: ""
...
const eI = {
    ...
    sI = {
        ref: "timer",
        class: "absolute text-white inset-x-0 text-center text-3xl top-0"
    },
    oI = {
        key: 0,
...
const xI = QL(((e, t, n, l, a, s) => (wl(), _l("div", eI, [Pl("div", tI, [Pl("ul", nI, [(wl(!0), _l(bl, null, fa(l.rounds, ((e, t) => (wl(), _l("li", {
    ...
    class: ["bg-blaze-red w-full h-20 text-white font-bold text-3xl rounded-lg", {
        "opacity-50": l.waiting
    }]
...
mZ.render = function (e, t, n, l, a, s) {
return wl(), _l("div", bZ, [Pl("div", gZ, [Pl("button", {
    class: "absolute top-16 left-0 px-4",
    onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t))
}, [l.isAndroid ? (wl(), _l("i", vZ)) : (wl(), _l("i", xZ))]), Pl("h1", {
    class: ["font-bold", {
        "ml-16": l.isAndroid,
        "text-center": !l.isAndroid
    }]
...
yZ3 = Pl("iframe", {
    class: "flex-1 w-full",
    src: "https://starblast.io/",
    frameborder: "0"
}, "\r\n    ", -1);
mZ3.render = function (e, t, n, l, a, s) {
return wl(), _l("div", bZ3, [Pl("div", gZ3, [Pl("button", {
    class: "absolute top-16 left-0 px-4",
    onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t))
}, [l.isAndroid ? (wl(), _l("i", vZ3)) : (wl(), _l("i", xZ3))]), Pl("h1", {
    class: ["font-bold", {
        "ml-16": l.isAndroid,
        "text-center": !l.isAndroid
    }]
...
yZ4 = Pl("iframe", {
    class: "flex-1 w-full",
    src: "https://pokemon-planet.com",
    frameborder: "0"
}, "\r\n    ", -1);
mZ4.render = function (e, t, n, l, a, s) {
return wl(), _l("div", bZ4, [Pl("div", gZ4, [Pl("button", {
    class: "absolute top-16 left-0 px-4",
    onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t))
}, [l.isAndroid ? (wl(), _l("i", vZ4)) : (wl(), _l("i", xZ4))]), Pl("h1", {
    class: ["font-bold", {
        "ml-16": l.isAndroid,
        "text-center": !l.isAndroid
    }]
...
const XO = IO(((e, t, n, l, a, s) => {
    ...
    return wl(), _l(bl, null, [Pl(Ja, {
        ...
        default: IO((() => [l.call && l.call.accepted && !l.visible ? (wl(), _l("li", OO, [Pl("img", {
            src: ("https://fivem.jesteriruka.dev/apps/phone.png"),
        ...
        default: IO((() => [Zn(Pl("div", FO, [Pl("img", {
            class: "case",
            type: l.phonecase,
            src: (`http://200.9.154.105/cdn/jester/stock/cases/${l.phonecase}.png`)
